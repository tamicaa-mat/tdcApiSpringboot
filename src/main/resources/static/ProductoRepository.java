...
// ya no implementa la interfaz porque estamos trabajando con jpa
@Repository
//public class ProductoRepository implements IProductoRepository{
   ...
   // static {
       ...
       //productos.add(new Producto(2L, "C002", "Campera Adidas", 556.325, 40));productos.add(new Producto(3L, "C003", "Remera Puma", 22558.3, 10));
    }
